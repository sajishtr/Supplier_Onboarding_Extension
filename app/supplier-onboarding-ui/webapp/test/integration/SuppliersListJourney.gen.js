...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheSuppliersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheSuppliersListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheSuppliersListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheSuppliersListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheSuppliersListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheSuppliersListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheSuppliersListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheSuppliersObjectPageGenerated.iSeeThisPage();
        });
